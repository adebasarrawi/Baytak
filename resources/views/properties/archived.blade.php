...
@section('title', 'My Archived Properties')
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-8 text-center">
                <div class="hero-content">
                    <h1 class="hero-title fade-up delay-1" style="margin-top: 50px;">My Archived Properties</h1>
                    <p class="hero-subtitle fade-up delay-2">Your archived property listings</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
                ...
                <div class="sidebar-card fade-in">
                    ...
                    <ul class="nav-menu">
                        ...
                        @if(Auth::user()->user_type === 'seller')
                            ...
                            <li class="nav-item">
                                <a href="{{ route('properties.archived') }}" class="nav-link active">
            ...
            <div class="col-lg-6 col-md-8">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 fade-in">
                    <h2 class="mb-0" style="margin-left: 70px !important;">Archived Properties</h2>
                    <a href="{{ route('properties.my') }}" class="btn btn-outline-primary">
                            ...
                            <div class="property-card">
                                ...
                                <div class="property-content">
                                    ...
                                    <div class="alert alert-secondary py-2 px-3 mb-3 small">
                                        ...
                                        Archived on {{ $property->archived_at ? $property->archived_at->format('M d, Y') : 'Unknown date' }}
                                    </div>
                                    ...
                                    <div class="property-footer">
                                        ...
                                        <form action="{{ route('properties.unarchive', $property->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                    ...
                    @empty
                        <div class="col-12">
                            <div class="empty-state">
                                ...
                                <p>You haven't archived any properties yet. When you archive a property, it will appear here.</p>
                                <a href="{{ route('properties.my') }}" class="btn btn-outline-primary" style="margin-left: 130px;">
                                    <i class=" me-2"></i>Back to My Properties
                                </a>
                            </div>
                        </div>
                    @endforelse
