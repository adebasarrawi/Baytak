    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-10 text-center hero-content">
                <!-- <h1 class="fade-in " style="margin-top: 90px;">Find Your Perfect Home</h1> -->
                
                <!-- Search Section -->
                <div class="search-section fade-in" style="margin-top: 150px;">
                    <!-- Search Tabs -->
                    ...
                    <form action="{{ route('properties.index') }}" method="GET" class="search-form">
                        ...
                        <!-- Search Button -->
                        <button type="submit" class="search-btn" style="margin-top: 15px;">
